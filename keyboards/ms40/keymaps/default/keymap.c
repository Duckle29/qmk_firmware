...
[_QWERTY] = LAYOUT_ortho_4x12( \
  ...
  KC_LGUI,  KC_LALT, ADJUST,  LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP  \
),
...
[_ADJUST] =  LAYOUT_ortho_4x12( \
   RESET , _______, _______, _______, _______, _______, _______, _______,  RESET , KC_DEL , \
  _______, _______, _______, _______, _______,  QWERTY, COLEMAK,  DVORAK, _______, _______, \
